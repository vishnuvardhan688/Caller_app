...
ActiveRecord::Schema.define(version: 2022_09_16_095346) do

  create_table "accounts", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "account_sid", limit: 50, null: false
    t.string "auth_token", limit: 50, null: false
  ...
  create_table "call", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "user_id", null: false
    t.integer "duration", null: false
    t.string "from", limit: 45, null: false
